...
public:
  ...
  friend float tripleProduct(const Vector3& v1, const Vector3& v2,
const Vector3& v3);
  friend bool isEmpty(const Vector3& v1);
...
inline bool isEmpty(const Vector3& v1){
	return (v1.x() == 0.0001 || v1.y() ==0.0001 || v1.z()==0.0001);
